$(document).ready(function() {
    ...
    function show_data(){
        $.ajax({
            method :'GET',
            url  : api_base_url+'branch/pool/list_pool',
            dataType : 'json',
            async: false,       
            processData: false,
            contentType: false,   
    ...
    function add_pool() {
        ...
        $.ajax({
            type : "POST",
            url  : api_base_url+'branch/pool/create',
            dataType : "JSON",
            data : adddata,
            async: false,
            processData: false,
            ...
            success: function(data){
                ...
                console.log(data);
                window.location.href = base_url+"branch/pool";
    ...
    $('#delete_bt').on('click',function(){
        ...
        $.ajax({
            type : "POST",
            url  : api_base_url+'branch/pool/delete',
            dataType : "JSON",
            ...
            success: function(data){
                ...
                window.location.href = base_url+"branch/pool/index";
    ...
    $('#example').on('click','.item_view',function(){
        ...
        var pool_id = $(this).data('pool_id');
        window.location.href = base_url+"branch/pool/edit/"+pool_id;
    ...
    function update_pool() {
        ...
        $.ajax({
            type : "POST",
            url  : api_base_url+'branch/pool/update',
            dataType : "JSON",
            data : adddata,
            async: false,
            processData: false,
...
function getDropdownData(){
    $.ajax({
        method :'GET',
        url  : api_base_url+'branch/pool/getData',
        dataType : 'json', 
        headers: {
            "auth-key":"simplerestapi",
            'client-service' : "frontend-client",
...
function getData(pool_id){
    $.ajax({
        url  : api_base_url+'branch/pool/detail/'+pool_id,
        method : 'POST',
        data:{'pool_id':pool_id},
        dataType : 'json', 
        headers: {
