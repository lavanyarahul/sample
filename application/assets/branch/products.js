$(document).ready(function() {
    ...
    function show_data(){
        $.ajax({
            method :'GET',
            url  : api_base_url+'branch/products/list_product',
            dataType : 'json',
            async: false,       
            processData: false,
            contentType: false,   
    ...
    function add_products() {
        ...
        $.ajax({
            type : "POST",
            url  : api_base_url+'branch/products/create',
            dataType : "JSON",
            data : adddata,
            async: false,
            processData: false,
            ...
            success: function(data){
                ...
                console.log(data);
                window.location.href = base_url+"branch/products";
    ...
    $('#delete_bt').on('click',function(){
        ...
        $.ajax({
            type : "POST",
            url  : api_base_url+'branch/products/delete',
            dataType : "JSON",
            ...
            success: function(data){
                ...
                window.location.href = base_url+"branch/products/index";
    ...
    $('#example').on('click','.item_view',function(){
        ...
        var product_id = $(this).data('product_id');
        window.location.href = base_url+"branch/products/edit/"+product_id;
    ...
    function update_products() {
        ...
        $.ajax({
            type : "POST",
            url  : api_base_url+'branch/products/update',
            dataType : "JSON",
            data : adddata,
            async: false,
            processData: false,
    ...
    $('#returnBtn').on('click',function(){
        ...
        $.ajax({
            type : "POST",
            url  : api_base_url+'branch/issue_product/return_products',
            dataType : "JSON",
            ...
            success: function(data){
                ...
                window.location.href = base_url+"branch/issue_product/issue_products";
...
function getDropdownData(){
    $.ajax({
        method :'GET',
        url  : api_base_url+'branch/products/getData',
        dataType : 'json', 
        headers: {
            "auth-key":"simplerestapi",
            'client-service' : "frontend-client",
...
function getData(product_id){
    $.ajax({
        url  : api_base_url+'branch/products/detail/'+product_id,
        method : 'POST',
        data:{'product_id':product_id},
        dataType : 'json', 
        headers: {
