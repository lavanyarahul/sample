$(document).ready(function() {
    ...
    function show_data(){
        $.ajax({
            method :'GET',
            url  : api_base_url+'branch/ride/list_ride',
            dataType : 'json',
            async: false,       
            processData: false,
            contentType: false,   
    ...
    function add_ride() {
        ...
        $.ajax({
            type : "POST",
            url  : api_base_url+'branch/ride/create',
            dataType : "JSON",
            data : adddata,
            async: false,
            processData: false,
            ...
            success: function(data){
                ...
                console.log(data);
                window.location.href = base_url+"branch/ride";
    ...
    $('#delete_bt').on('click',function(){
        ...
        var ride_id = $('#id').val();
         $.ajax({
            type : "POST",
            url  : api_base_url+'branch/ride/delete',
            dataType : "JSON",
            ...
            success: function(data){
                console.log(data)
                  window.location.href = base_url+"branch/ride/index";
    ...
    $('#example').on('click','.item_view',function(){
        ...
        var ride_id = $(this).data('ride_id');
        window.location.href = base_url+"branch/ride/edit/"+ride_id;
    ...
    function update_ride() {
        ...
        $.ajax({
            type : "POST",
            url  : api_base_url+'branch/ride/update',
            dataType : "JSON",
            data : adddata,
            async: false,
            processData: false,
...
function getDropdownData(){
    $.ajax({
        method :'GET',
        url  : api_base_url+'branch/ride/getData',
        dataType : 'json', 
        headers: {
            "auth-key":"simplerestapi",
            'client-service' : "frontend-client",
...
function getRideData(ride_id){
    $.ajax({
        url  : api_base_url+'branch/ride/detail/'+ride_id,
        method : 'POST',
        data:{'ride_id':ride_id},
        dataType : 'json', 
        headers: {
