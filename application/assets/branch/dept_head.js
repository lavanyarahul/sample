$(document).ready(function() {
    ...
    function show_data(){
        $.ajax({
            method :'GET',
            url  : api_base_url+'branch/department_head/list_dept_head',
            dataType : 'json',
            async: false,       
            processData: false,
            contentType: false,   
    ...
    function add_accounts_users() {
        ...
        $.ajax({
            type : "POST",
            url  : api_base_url+'branch/department_head/create',
            dataType : "JSON",
            data : adddata,
            async: false,
            processData: false,
            ...
            success: function(data){ 
                window.location.href = base_url+"branch/department_head";
            },
            error: function(data) {
                //Your Error Message
                console.log(data)
    ...
    $('#example').on('click','.item_view',function(){
        ...
        window.location.href = base_url+"branch/department_head/edit/"+user_id;
    ...
    $('#delete_bt').on('click',function(){
        ...
        $.ajax({
            type : "POST",
            url  : api_base_url+'branch/department_head/delete',
            dataType : "JSON",
    ...
    function update_accounts_user() {
        ...
        $.ajax({
            type : "POST",
            url  : api_base_url+'branch/department_head/update',
            dataType : "JSON",
            data : adddata,
            async: false,
            processData: false,
...
function getDropdownData(){
    $.ajax({
        method :'GET',
        url  : api_base_url+'branch/department_head/getData',
        dataType : 'json', 
        headers: {
            "auth-key":"simplerestapi",
            'client-service' : "frontend-client",
...
function getUserData(user_id){
    $.ajax({
        method :'POST',
        url  : api_base_url+'branch/department_head/detail',
        data:{'user_id':user_id},
        dataType : 'json', 
        headers: {
            "auth-key":"simplerestapi",
