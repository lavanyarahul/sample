$(document).ready(function() {
    ...
    function show_data(){
         $.ajax({
            method :'GET',
            url  : api_base_url+'branch/ride_checklist/list_checklist',
            dataType : 'json',
            async: false,       
            processData: false,
            contentType: false,   
    ...
    function assign_ride() {
        ...
        $.ajax({
            type : "POST",
            url  : api_base_url+'branch/ride_checklist/assign',
            dataType : "JSON",
            data : adddata,
            async: false,
            processData: false,
            ...
            success: function(data){
                ...
                console.log(data);
                window.location.href = base_url+"branch/ride_checklist";
    ...
    $('#example').on('click','.item_delete',function(){
        ...
        $.ajax({
            type : "POST",
            url  : api_base_url+'branch/ride_checklist/getData',
            dataType : "JSON",
