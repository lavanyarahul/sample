$(document).ready(function() {
    ...
    function show_data(){
        $.ajax({
            method :'GET',
            url  : api_base_url+'branch/location/list_location',
            dataType : 'json',
            async: false,       
            processData: false,
            contentType: false,   
    ...
    function add_location() {
        ...
        $.ajax({
            type : "POST",
            url  : api_base_url+'branch/location/create',
            dataType : "JSON",
            data : adddata,
            async: false,
            processData: false,
            ...
            success: function(data){
                ...
                console.log(data);
                window.location.href = base_url+"branch/location";
    ...
    $('#delete_bt').on('click',function(){
        ...
        $.ajax({
            type : "POST",
            url  : api_base_url+'branch/location/delete',
            dataType : "JSON",
            ...
            success: function(data){
                ...
                window.location.href = base_url+"branch/location/index";
    ...
    $('#example').on('click','.item_view',function(){
        ...
        var location_id = $(this).data('location_id');
        window.location.href = base_url+"branch/location/edit/"+location_id;
    ...
    function update_location() {
        ...
        $.ajax({
            type : "POST",
            url  : api_base_url+'branch/location/update',
            dataType : "JSON",
            data : adddata,
            async: false,
            processData: false,
...
function getData(location_id){
    $.ajax({
        method :'POST',
        url  : api_base_url+'branch/location/detail',
        data:{'location_id':location_id},
        dataType : 'json',
