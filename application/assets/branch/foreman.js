$(document).ready(function() {
    ...
    function show_data(){
        $.ajax({
            method :'GET',
            url  : api_base_url+'branch/foreman/list_foreman',
            dataType : 'json',
            async: false,       
            processData: false,
            contentType: false,   
    ...
    function add_foreman_users() {
        ...
        $.ajax({
            type : "POST",
            url  : api_base_url+'branch/foreman/create',
            dataType : "JSON",
            data : adddata,
            async: false,       
            processData: false,
            ...
            success: function(data){
                ...
                console.log(data);
                window.location.href = base_url+"branch/foreman";
    ...
    $('#example').on('click','.item_view',function(){
        ...
        window.location.href = base_url+"branch/foreman/edit/"+user_id;
    ...
    $('#delete_bt').on('click',function(){
        ...
        $.ajax({
            type : "POST",
            url  : api_base_url+'branch/foreman/delete',
            dataType : "JSON",
    ...
    function update_foreman_user() {
        ...
        $.ajax({
            type : "POST",
            url  : api_base_url+'branch/foreman/update',
            dataType : "JSON",
            data : adddata,
            async: false,       
            processData: false,
...
function getDropdownData(){
    $.ajax({
        method :'GET',
        url  : api_base_url+'branch/foreman/getData',
        dataType : 'json', 
        headers: {
            "auth-key":"simplerestapi",
            'client-service' : "frontend-client",
...
function getUserData(user_id){
    ...
    $.ajax({
        method :'POST',
        url  : api_base_url+'branch/foreman/detail',
        data:{'user_id':user_id},
        dataType : 'json', 
        headers: {
            "auth-key":"simplerestapi",
        ...
        success: function(res){
            ...
            select_eng.value = data.branch_id; 
