...
$(document).ready(function(){   
  ...
  jQuery.validator.addMethod("noSpace", function(value, element) { 
    ...
    $("#changePassword").validate({
        rules: { 
            old_password: {
              ...
              remote: {
                    url : base_url+'branch/profile/check_password',
                    type : "POST",
   ...
   { 
            ...
            $.ajax({
                type : "POST",
                url  : base_url+'branch/profile/change_password',
                dataType : "JSON",
   ...
   // enable to edit
    ...
    $("#profile_form").validate({
     ...
     function update_profile() {
      ...
      $.ajax({
          type : "POST",
          url  : base_url+'branch/profile/update_profile',
          dataType : "JSON",
          data : adddata,
          async: false,       
          processData: false,
          ...
          success: function(data){
            ...
            console.log(data);
            window.location.href = base_url+"branch/dashboard";
