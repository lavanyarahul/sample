$(document).ready(function() {
   jQuery.validator.addMethod("noSpace", function(value, element) {
    ...
    function show_data(){
        $.ajax({
            method :'GET',
            url  : api_base_url+'branch/technician_assistant/list_technician_assistant',
            dataType : 'json',
            async: false,       
            processData: false,
            contentType: false,   
...
*/
  ...
  function add_technician_assistant_users() {
      ...
      $.ajax({
          type : "POST",
          url  : api_base_url+'branch/technician_assistant/create',
          dataType : "JSON",
          data : adddata,
          async: false,
          processData: false,
          ...
          success: function(data){
            ...
            console.log(data);
            window.location.href = base_url+"branch/technician_assistant";
  ...
  $('#example').on('click','.item_view',function(){
    ...
    window.location.href = base_url+"branch/technician_assistant/edit/"+user_id;
  ...
  $('#delete_bt').on('click',function(){
    ...
    $.ajax({
        type : "POST",
        url  : api_base_url+'branch/technician_assistant/delete',
        dataType : "JSON",
         headers: {
            "auth-key":"simplerestapi",
            'client-service' : "frontend-client",
...
*/
    ...
    function update_technician_assistant_user() {
      ...
      $.ajax({
          type : "POST",
          url  : api_base_url+'branch/technician_assistant/update',
          dataType : "JSON",
          data : adddata,
          async: false,
          processData: false,
