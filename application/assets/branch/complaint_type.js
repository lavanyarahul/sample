$(document).ready(function() {
    ...
    function show_data(){
        $.ajax({
            method :'GET',
            url  : api_base_url+'branch/complaint/list_complaint',
            dataType : 'json',
            async: false,       
            processData: false,
            contentType: false,   
    ...
    function add_complaint() {
        ...
        $.ajax({
            type : "POST",
            url  : api_base_url+'branch/complaint/create',
            dataType : "JSON",
            data : adddata,
            async: false,
            processData: false,
            ...
            success: function(data){
                ...
                console.log(data);
                window.location.href = base_url+"branch/complaint";
    ...
    $('#delete_bt').on('click',function(){
        ...
        $.ajax({
            type : "POST",
            url  : api_base_url+'branch/complaint/delete',
            dataType : "JSON",
            headers: {
                "auth-key":"simplerestapi",
                'client-service' : "frontend-client",
            ...
            success: function(data){
                ...
                window.location.href = base_url+"branch/complaint/index";
    ...
    $('#example').on('click','.item_view',function(){
        ...
        var type_id = $(this).data('type_id');
        window.location.href = base_url+"branch/complaint/edit/"+type_id;
    ...
    function update_complaint() {
        ...
        $.ajax({
            type : "POST",
            url  : api_base_url+'branch/complaint/update',
            dataType : "JSON",
            data : adddata,
            async: false,
            processData: false,
...
function getData(type_id){
    $.ajax({
        method :'POST',
        url  : api_base_url+'branch/complaint/detail',
        data:{'type_id':type_id},
        dataType : 'json',
