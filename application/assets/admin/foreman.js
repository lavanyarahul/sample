$(document).ready(function() {
    ...
    function show_data(){
        $.ajax({
            method :'GET',
            url  : api_base_url+'admin/foreman/list_foreman',
            dataType : 'json',
            async: false,       
            processData: false,
            contentType: false,   
    ...
    $("#form_add").validate({
        ...
        submitHandler: function(form) { add_foreman_users(); }
    });

    function add_foreman_users() {

        var adddata = new FormData(document.getElementById("form_add"));
        $.ajax({
            type : "POST",
            url  : api_base_url+'admin/foreman/create',
            dataType : "JSON",
            data : adddata,
            async: false,       
            processData: false,
            ...
            success: function(data){
                ...
                console.log(data);
                window.location.href = base_url+"admin/foreman";
    ...
    $('#example').on('click','.item_view',function(){
        ...
        window.location.href = base_url+"admin/foreman/edit/"+user_id;

    });

    // delete foreman_users - start
    ...
    $('#delete_bt').on('click',function(){
        ...
        $.ajax({
            type : "POST",
            url  : api_base_url+'admin/foreman/delete',
            dataType : "JSON",
    ...
    $("#form_update").validate({
        ...
        submitHandler: function(form) { update_foreman_user(); }
    });

    function update_foreman_user() {

        var adddata = new FormData(document.getElementById("form_update"));
        $.ajax({
            type : "POST",
            url  : api_base_url+'admin/foreman/update',
            dataType : "JSON",
            data : adddata,
            async: false,       
            processData: false,
...
function getDropdownData(){
    $.ajax({
        method :'GET',
        url  : api_base_url+'admin/foreman/getData',
        dataType : 'json', 
        headers: {
            "auth-key":"simplerestapi",
            'client-service' : "frontend-client",
...
function getUserData(user_id){
     $.ajax({
        method :'POST',
        url  : api_base_url+'admin/foreman/detail',
        data:{'user_id':user_id},
        dataType : 'json', 
        headers: {
            "auth-key":"simplerestapi",
