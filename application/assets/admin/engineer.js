$(document).ready(function() {
    ...
    function show_data(){
        $.ajax({
            method :'GET',
            url  : api_base_url+'admin/engineer/list_engineers',
            dataType : 'json',
            async: false,       
            processData: false,
            contentType: false,   
    ...
    function add_engineer_users() {
        ...
        $.ajax({
            type : "POST",
            url  : api_base_url+'admin/engineer/create',
            dataType : "JSON",
            data : adddata,
            async: false,
            processData: false,
            ...
            success: function(data){
                ...
                console.log(data);
                window.location.href = base_url+"admin/engineer";
    ...
    $('#example').on('click','.item_view',function(){
        ...
        window.location.href = base_url+"admin/engineer/edit/"+user_id;
    ...
    $('#delete_bt').on('click',function(){
        ...
        $.ajax({
            type : "POST",
            url  : api_base_url+'admin/engineer/delete',
            dataType : "JSON",
    ...
    function update_engineer_user() {
        ...
        $.ajax({
            type : "POST",
            url  : api_base_url+'admin/engineer/update',
            dataType : "JSON",
            data : adddata,
            async: false,
            processData: false,
...
function getDropdownData(){
    $.ajax({
        method :'GET',
        url  : api_base_url+'admin/engineer/getData',
        dataType : 'json', 
        headers: {
            "auth-key":"simplerestapi",
            'client-service' : "frontend-client",
        ...
        success: function(data){
            ...
            if($('#branch_id').length > 0){
                ...
                $('#branch_id').empty();
                var branchResult = '';
                document.getElementById('branch_id').innerHTML='<option value="0" selected disabled>Select Park</option>';
...
function getUserData(user_id){
    $.ajax({
        method :'POST',
        url  : api_base_url+'admin/engineer/detail',
        data:{'user_id':user_id},
        dataType : 'json', 
        headers: {
            "auth-key":"simplerestapi",
