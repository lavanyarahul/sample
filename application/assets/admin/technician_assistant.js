$(document).ready(function() {
    ...
    function show_data(){
        $.ajax({
            method :'GET',
            url  : api_base_url+'admin/technician_assistant/list_technician_assistant',
            dataType : 'json',
            async: false,       
            processData: false,
            contentType: false,   
    ...
    $("#form_add").validate({
        ...
        submitHandler: function(form) { add_technician_assistant_users(); }
    });

    function add_technician_assistant_users() {

        var adddata = new FormData(document.getElementById("form_add"));
        $.ajax({
            type : "POST",
            url  : api_base_url+'admin/technician_assistant/create',
            dataType : "JSON",
            data : adddata,
            async: false,
            processData: false,
            ...
            success: function(data){
                ...
                console.log(data);
                window.location.href = base_url+"admin/technician_assistant";
    ...
    $('#example').on('click','.item_view',function(){
        ...
        window.location.href = base_url+"admin/technician_assistant/edit/"+user_id;

    });

    // delete technician_assistant_users - start
    ...
    $('#delete_bt').on('click',function(){
        ...
        $.ajax({
            type : "POST",
            url  : api_base_url+'admin/technician_assistant/delete',
            dataType : "JSON",
            headers: {
                "auth-key":"simplerestapi",
                'client-service' : "frontend-client",
    ...
    // delete technician_assistant_users - end
    ...
    $("#form_update").validate({
        ...
        submitHandler: function(form) { update_technician_assistant_user(); }
    });

    function update_technician_assistant_user() {

        var adddata = new FormData(document.getElementById("form_update"));
        $.ajax({
            type : "POST",
            url  : api_base_url+'admin/technician_assistant/update',
            dataType : "JSON",
            data : adddata,
            async: false,
            processData: false,
...
function getDropdownData(){
    $.ajax({
        method :'GET',
        url  : api_base_url+'admin/technician/getData',
        dataType : 'json', 
        headers: {
            "auth-key":"simplerestapi",
            'client-service' : "frontend-client",
...
function getUserData(user_id){
    $.ajax({
        method :'POST',
        url  : api_base_url+'admin/technician/detail',
        data:{'user_id':user_id},
        dataType : 'json', 
        headers: {
            "auth-key":"simplerestapi",
        ...
        success: function(res){
            ...
            var select_branch = document.getElementById('branch_id');
            ...
            for(i=0; i<engineer_list.length; i++){
                if(engineer_list[i].user_id == data.assign_to){
...
function getEngData(branch_id){

    $.ajax({
       method :'POST',
       url  : api_base_url+'admin/foreman/getEngData',
