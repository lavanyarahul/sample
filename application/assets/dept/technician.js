$(document).ready(function() {
    ...
    function show_data(){
        $.ajax({
            method :'GET',
            url  : api_base_url+'dept/technician/list_technician',
            dataType : 'json',
            async: false,       
            processData: false,
            contentType: false,   
    ...
    function add_technician_users() {
        ...
        $.ajax({
            type : "POST",
            url  : api_base_url+'dept/technician/create',
            dataType : "JSON",
            data : adddata,
            async: false,       
            processData: false,
            ...
            success: function(data){
                ...
                console.log(data);
                window.location.href = base_url+"dept/technician";
    ...
    $('#example').on('click','.item_view',function(){
        ...
        window.location.href = base_url+"dept/technician/edit/"+user_id;
    ...
    $('#delete_bt').on('click',function(){
        ...
        $.ajax({
            type : "POST",
            url  : api_base_url+'dept/technician/delete',
            dataType : "JSON",
    ...
    function update_technician_user() {
        ...
        $.ajax({
            type : "POST",
            url  : api_base_url+'dept/technician/update',
            dataType : "JSON",
            data : adddata,
            async: false,       
            processData: false,
