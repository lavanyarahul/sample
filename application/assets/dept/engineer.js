$(document).ready(function() {
    ...
    function show_data(){
        $.ajax({
            method :'GET',
            url  : api_base_url+'dept/engineer/list_engineers',
            dataType : 'json',
            async: false,       
            processData: false,
            contentType: false,   
    ...
    function add_engineer_users() {
        ...
        $.ajax({
            type : "POST",
            url  : api_base_url+'dept/engineer/create',
            dataType : "JSON",
            data : adddata,
            async: false,
            processData: false,
            ...
            success: function(data){
                ...
                console.log(data);
                window.location.href = base_url+"dept/engineer";
    ...
    $('#example').on('click','.item_view',function(){
        ...
        window.location.href = base_url+"dept/engineer/edit/"+user_id;
    ...
    $('#delete_bt').on('click',function(){
        ...
        $.ajax({
            type : "POST",
            url  : api_base_url+'dept/engineer/delete',
            dataType : "JSON",
    ...
    function update_engineer_user() {
        ...
        $.ajax({
            type : "POST",
            url  : api_base_url+'dept/engineer/update',
            dataType : "JSON",
            data : adddata,
            async: false,
            processData: false,
...
function getDropdownData(){
    $.ajax({
        method :'GET',
        url  : api_base_url+'dept/engineer/getData',
        dataType : 'json', 
        headers: {
            "auth-key":"simplerestapi",
            'client-service' : "frontend-client",
...
function getUserData(user_id){
    $.ajax({
        url  : api_base_url+'dept/engineer/detail',
        method :'POST',
        data:{'user_id':user_id},
        dataType : 'json', 
        headers: {
