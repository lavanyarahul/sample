$(document).ready(function() {
    ...
    function show_data(){
        $.ajax({
            method :'GET',
            url  : api_base_url+'dept/technician_assistant/list_technician_assistant',
            dataType : 'json',
            async: false,       
            processData: false,
            contentType: false,   
    ...
    function add_technician_assistant_users() {
        ...
        $.ajax({
            type : "POST",
            url  : api_base_url+'dept/technician_assistant/create',
            dataType : "JSON",
            data : adddata,
            async: false,
            processData: false,
            ...
            success: function(data){
                ...
                console.log(data);
                window.location.href = base_url+"dept/technician_assistant";
    ...
    $('#example').on('click','.item_view',function(){
        ...
        window.location.href = base_url+"dept/technician_assistant/edit/"+user_id;
    ...
    $('#delete_bt').on('click',function(){
        ...
        $.ajax({
            type : "POST",
            url  : api_base_url+'dept/technician_assistant/delete',
            dataType : "JSON",
            headers: {
                "auth-key":"simplerestapi",
                'client-service' : "frontend-client",
    ...
    function update_technician_assistant_user() {
        ...
        $.ajax({
            type : "POST",
            url  : api_base_url+'dept/technician_assistant/update',
            dataType : "JSON",
            data : adddata,
            async: false,
            processData: false,
...
function getDropdownData(){
    $.ajax({
        method :'GET',
        url  : api_base_url+'dept/technician/getData',
        dataType : 'json', 
        headers: {
            "auth-key":"simplerestapi",
            'client-service' : "frontend-client",
...
function getUserData(user_id){
    $.ajax({
        method :'POST',
        url  : api_base_url+'dept/technician/detail',
        data:{'user_id':user_id},
        dataType : 'json', 
        headers: {
            "auth-key":"simplerestapi",
