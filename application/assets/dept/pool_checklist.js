$(document).ready(function() {
    ...
    function show_data(){
        $.ajax({
            method :'GET',
            url  : api_base_url+'dept/pool_checklist/list_checklist',
            dataType : 'json',
            async: false,       
            processData: false,
            contentType: false,   
    ...
    function assign_pool() {
        ...
        $.ajax({
            type : "POST",
            url  : api_base_url+'dept/pool_checklist/assign',
            dataType : "JSON",
            data : adddata,
            async: false,
            processData: false,
            ...
            success: function(data){
                ...
                console.log(data);
                window.location.href = base_url+"dept/pool_checklist";
    ...
    $('#example').on('click','.item_delete',function(){
        ...
        $.ajax({
            type : "POST",
            url  : api_base_url+'dept/pool_checklist/getData',
            dataType : "JSON",
